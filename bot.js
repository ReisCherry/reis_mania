...
function handleMsg(raw) {
  ...
  switch (msg.t) {
    case 'captcha':
      ...
      console.log('\n==================================================');
      console.log('🚨 WARNING: A captcha has appeared on your account!');
      console.log(`   Question: ${msg.q || 'Unknown'}`);
      console.log(`   Options : ${msg.answers ? msg.answers.join(', ') : 'None'}`);
      console.log('   Stopping the bot immediately to prevent ban/lock...');
      console.log('==================================================\n');
      stopIntervals();
